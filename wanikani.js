...
$(document).ready(function() {
	...
	if (!siteSection || siteSection === 'dashboard') {
		...
		$('#stats').prepend('<div id="customizer-stats"><i class="icon-level"></i><span id="current-count"></span></div>');
	}
	// if (!isChromeExtension) { TODO Safari options
	// 	$('.dropdown-menu').append('<li><a id="customizer-options" href="#">Customizer</a></li>');
	// 	$(document).on('click', '#customizer-options', function() {
	// 		window.open(resourceUrlFor('options.html'));
	// 		return false;
	// 	});
	// }
});
